...
### 🚀 Features & Nuevas Funcionalidades
- add extractLatencyMs utility and default fallback for server latency (`2939445`)
...
### 🚀 Features & Nuevas Funcionalidades
- **branding:** adapt instance logos dynamically by active theme (`88395b9`)

## [v2.5.101 (Frontend) / v2.5.94 (Backend)] - 2026-09-10

### 🐛 Corregido & Bug Fixes
- **teams:** prevent onboarding modal from auto opening on every access and allow closing it (`3659edc`)
...
### 🚀 Features & Nuevas Funcionalidades
- **teams:** add unique slug identifier and URL preview to team onboarding flow (`8898531`)
...
### 🚀 Features & Nuevas Funcionalidades
- **storage:** implement S3-compatible Bunny Storage integration and CDN distribution (`b65f7b3`)
...
### 🚀 Features & Nuevas Funcionalidades
- **auth:** implement secure httpOnly session cookie validation and lifecycle management (`5ba7876`)
...
### 🚀 Features & Nuevas Funcionalidades
- **db:** generate baseline migration 0_init and sync migration history (`c4def27`)
...
### 🐛 Corregido & Bug Fixes
- **db:** add self-healing schema migration and auto-repair for missing postgres columns (v2.5.67) (`ba13dfb`)
...
* **reports:** corregir persistencia, invalidación de caché y sincronización en guardado de reportes ([6a2ab69](https://github.com/Calmecac-MX/Tlamatqui/commit/6a2ab69518109fc28164c4f90c95c26eff643521))
