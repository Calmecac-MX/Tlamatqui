...
> **Proyecto:** Tlamatqui  
> **Versión:** v2.5.109 (Frontend) / v2.5.102 (Backend)  
...
2. **Generación Automática en CI/CD:** El workflow [`.github/workflows/omeyocan.yml`](file:///.github/workflows/omeyocan.yml) ejecuta `googleapis/release-please-action` en la rama `omeyocan` para crear PRs automáticas de versión y release notes.
