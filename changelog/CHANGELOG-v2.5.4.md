# Extracto Detallado de Cambios - Versión v2.5.4

- **Versión de Actualización:** `v2.5.4`
...
Este archivo contiene el desglose y extracto detallado de todos los cambios, mejoras, correcciones y tareas de mantenimiento correspondientes a la versión **v2.5.4** de Tlamatqui.
...
- **Versionado:** Generación automática de versión `v2.5.4` y actualización de contratos de API REST.
